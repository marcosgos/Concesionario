...
<body>
    ...
    // Consulta SQL
    $sql = "select usuarios.nombre, modelo, marca, color, precio, foto, prestado, devuelto from alquileres, usuarios, coches where alquileres.id_usuario=usuarios.id_usuario and alquileres.id_coche=coches.id_coche";
